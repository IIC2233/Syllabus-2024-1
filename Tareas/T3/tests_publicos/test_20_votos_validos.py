...
from test_solution import VOTOS_VALIDOS_S, VOTOS_VALIDOS_M, VOTOS_VALIDOS_L
...
class TestVotosValidos(unittest.TestCase):
    ...
    def test_0(self):
        ...
        lista_entregada1 = [
                ...
                Animal(1763, 'Lexi', 'Perro', 61, 0.071, 34, '1957/8'),
                ...
                Animal(3056, 'Shreya', 'Perro', 292, 7.8, 31, '1992/11'),
                Animal(531, 'Johanna', 'Pex dorado', 248, 0.525, 67, '1957/12'),
    ...
    def test_2(self):
        ...
        lista_entregada1 = [
                ...
                Animal(604, 'Darren', 'Gato', 41, 72.8, 60, '1963/1'),
                Animal(605, 'Tilden', 'Perro', 23, 0.056, 93, '1931/10'),
                Animal(606, 'Maryanne', 'Serpiente', 293, 1.35, 18, '2006/1'),
                Animal(3984, 'Hollie', 'Caballo', 1, 0.44, 13, '2011/9')
        ]
    ...
    def test_4(self):
        ...
        lista_entregada1 = [
                ...
                Animal(603, 'Lon', 'Gato', 201, 2.4, 82, '1941/2'),
                Animal(604, 'Darren', 'Gato', 41, 72.8, 60, '1963/1'),
                Animal(605, 'Tilden', 'Perro', 23, 0.056, 18, '2006/1'),
                Animal(606, 'Maryanne', 'Serpiente', 293, 1.35, 70, '1954/8'),
                Animal(3984, 'Hollie', 'Caballo', 1, 0.44, 13, '2011/9')
        ]
    ...
    def test_5(self):
        ...
        expected_output = VOTOS_VALIDOS_S
    ...
    def test_6(self):
        ...
        g_v =  cargar_datos("votos", carpeta)
        resultado = votos_validos(g_a, g_v, g_p)
        expected_output = VOTOS_VALIDOS_M
    ...
    def test_7(self):
        ...
        g_v =  cargar_datos("votos", carpeta)
        resultado = votos_validos(g_a, g_v, g_p)
        expected_output = VOTOS_VALIDOS_L
