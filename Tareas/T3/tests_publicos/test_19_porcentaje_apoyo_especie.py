...
class TestPorcentajeApoyoEspecie(unittest.TestCase):
    ...
    def test_0(self):
        ...
        lista_votos = [
            ...
            Votos(id_voto= 9, id_animal_votante= 9,  id_local = 10, id_candidato= 4), # GATO VOTO CANDIDATO 4
        ]
    ...
    def test_1(self):
        ...
        expected_output = [(2, 100), (3, 50), (4, 0), (6, 100), (7, 100)]
    ...
    def test_3(self):
        ...
        lista_animales = [
            ...
            Animales(id= 11, nombre="Flaquis" ,     especie= "Ballena",     id_comuna= 4,  peso_kg= 3121 , edad= 8 , fecha_nacimiento= "2015/8"),
            Animales(id= 12, nombre="Mocha" ,       especie= "Ballena",     id_comuna= 4,  peso_kg= 4111 , edad= 10 , fecha_nacimiento= "2013/8"),
        ]
        ...
        expected_output = [(2, 100), (3, 33), (4, 0), (6, 100), (7, 67)]
    ...
    def test_4(self):
        ...
        expected_output = [(2, 100), (3, 33), (4, 0), (6, 100), (7, 0)]
