---
name: Problemas de git
about: Problemas con el uso de git
title: ''
labels: ":octocat: Git"
assignees: ''
...
<!-- **Esta es una plantilla para que dejes dudas relacionadas con el uso o problemas con git. Si tienes dudas de otro tipo, utiliza la plantilla apropiada. Recuerda utilizar la pestaña "Preview" para ver cómo se vería tu *issue* antes de publicarla.** -->
